  ...
  slides: { img: string; titulo: string; desc: string }[] = [
    {
      ...
      titulo: 'Escanea tu Codigo',
      desc: 'Escanea tu codigo QR para marcar tu asistencia'
    },
    {
      img: '/assets/slides/user-6.svg',
      titulo: 'Tu Perfil',
      desc: 'Toda tu información al alcanze de tu mano'
    },
    {
      img: '/assets/slides/calendar.svg',
      titulo: 'Nunca olvides nada',
      desc: 'La mejor manera de recordar tu horario'
    },
    // {
